  ...
  return (
    <Box
      sx={{
        ...
        py: 4,
        background:
          "radial-gradient(circle at 20% 20%, #452350 0, transparent 30%), #17101f",
      }}
    >
          ...
          <Stack spacing={3}>
            <Stack alignItems="center" spacing={1}>
              ...
              <Typography color="text.secondary" textAlign="center">
                {isSignUp
                  ? "Get your crew together and start singing."
            ...
            {success && (
              <Alert severity="success">
                You’re signed in! Authentication is working.
              </Alert>
            )}
            <Button
              ...
              sx={{ py: 1.3, borderColor: "rgba(255,255,255,.2)" }}
            >
