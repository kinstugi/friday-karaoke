...
function HostDashboard({ onSignOut, onCreateSession, onOpenSession }: { onSignOut: () => void; onCreateSession: () => void; onOpenSession: (title: string, code: string, sessionId: string) => void }) {
